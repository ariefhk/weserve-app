...
const BestChoice = () => {
  const { handleHoverState, isHover } = useCheckHover()
  return (
    <section className="benefits max-w-6xl mx-auto py-12 md:px-8 px-4 xl:px-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-7 gap-y-8">
        ...
        <div
          ...
          className="item-card group hover:bg-[#080C2E] bg-white relative rounded-2xl p-7 gap-y-7 flex flex-col">
